...
public class DegreeListFragment extends ListFragment {
	 ...
	 * clicks.
	 */
	private Callbacks m_callbacks = m_dummyCallbacks;

	/**
	 * The current activated item position. Only tablets.
	 */
	 ...
	 */
	private static Callbacks m_dummyCallbacks = new Callbacks() {
		@Override
		public void onItemSelected(String number) {
		}
	};
